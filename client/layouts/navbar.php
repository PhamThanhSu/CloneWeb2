			...
			<div class="content-topbar flex-sb-m h-full container">
				...
				<div class="right-top-bar flex-w h-full">
					...
					if (isset($_COOKIE['client'])) {
						...
						// Truy vấn để lấy thông tin level của người dùng dựa vào UserID
						$stmt = $conn->prepare("SELECT UserID, Level FROM Users WHERE UserID = ? LIMIT 1");
						...
						if ($result && $result->num_rows > 0) {
							...
							$level = $user['Level'];
							$id_user = $user['UserID'];
							// Kiểm tra nếu level = 1 (admin)
							if ($level == 1) {
								// Lưu UserID vào cookie và chuyển hướng đến trang người dùng
								setcookie("user_id", $id_user, time() + (86400 * 30), "/");
								// Hiển thị liên kết đến trang admin nếu người dùng là admin
								echo '<a href="../admin2/index.php" class="flex-c-m trans-04 p-lr-25">Admin</a>';
							}
						}
					}
					?>
